...
<template>
  <div class="w-full p-2 border-b-2 border-gray-500 bg-gray-200">
    <!-- Header -->
    <RouterLink
      :to="`/sport/events/${sport}/${sportId}/${game.country}/${game.competitionName}/${game.events[0].eventName}_id${game.events[0].eventId}`"
    ...
    <div class="flex gap-1 text-[11px] mt-0.5">
      <div
